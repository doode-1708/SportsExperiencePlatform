...
from SportsExperiencePlatform.utils import language_translation, clean_string
from SportsExperiencePlatform.utils import haversine_vectorized
from SportsExperiencePlatform.utils import random_title, random_description
    ...
    # translation
        ...
        def get_transformed_df():
            ...
            def create_soup(x):
                ...
                random.shuffle(soup)
                return ' '.join(soup)
            self.events_df['soup'] = self.events_df.apply(create_soup, axis = 1)
